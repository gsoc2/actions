...
e.g. `cgr.dev/gsoc2/nginx:latest@sha256:81bed54c9e507503766c0f8f030f869705dae486f37c2a003bb5b12bcfcc713f`, digesta-bot
...
```yaml
    - uses: gsoc2/actions/digesta-bot@main
        with:
...
```yaml
defaultBaseImage: cgr.dev/gsoc2/kubectl:latest-dev@sha256:d5f340d044438351413d6cb110f6f8a2abc45a7149aa53e6ade719f069fc3b0a
```
...
spec:
  template:
    spec:
      restartPolicy: Never
      initContainers:
      - image: cgr.dev/gsoc2/cosign:latest-dev@sha256:09653ac03c1ac1502c3e3a8831ee79252414e4d659b423b71fb7ed8b097e9c88
...
```
...
```
FROM cgr.dev/gsoc2/busybox:latest@sha256:257157f6c6aa88dd934dcf6c2f140e42c2653207302788c0ed3bebb91c5311e1
```
  ...
  - target:
    ...
    patch: |-
      - op: replace
        ...
        value: cgr.dev/gsoc2/cert-manager-controller:1.11.1@sha256:819a8714fc52fe3ecf3d046ba142e02ce2a95d1431b7047b358d23df6759de6c
...
```